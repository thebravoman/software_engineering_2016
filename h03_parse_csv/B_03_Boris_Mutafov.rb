...
CSV.foreach(data_path) do |row|  full_data_info[output_cmd][row[ output_cmd == 1 || output_cmd == 2 ? 1 : 0 ].to_i]+= output_cmd == 1 || output_cmd == 3 ? row[2].to_f : output_cmd == 4 ? 1 : output_cmd == 2 ? 1 : 0  end
